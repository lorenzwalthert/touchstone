...
<img src="../inst/workflow-visualization.pdf">

Note that there are two GitHub Action workflows due to [security reasons](https://securitylab.github.com/research/github-actions-preventing-pwn-requests/).
