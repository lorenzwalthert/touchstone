...
* run the code you want to benchmark, many times, in random order. This ensures
  the accurate relative measurement of relative differences between the
  branches.
...
- create a `touchstone` directory in the repo root with:
  ...
  * `config.json` that defines how to run your benchmark. In particular, you can
    define a benchmarking repo, that is, code you need to run your bench mark.
    This repo will be cloned into `benchmarking_path`. The code you want to
...
If you want to call the script interactively, use `with_touchstone_lib()` (an
